...
Let me first try to give a little intro to typing protocols, or atleast the way I understood it.
...
I've already explained contracts.py.

#INPUT.PY


#CONTRACTS.PY
This module defines protocols(interfaces ig) that allow us to use
